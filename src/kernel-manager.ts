...
export abstract class KernelManagerImpl extends EventEmitter {
    ...
    constructor(protected outputChannel: intellij.OutputChannel, protected notebookManager: NotebookManager, protected jupyterClient: JupyterClientAdapter) {
        super();
        this.disposables = [];
    ...
    public static runCodeAsObservable(code: string, kernel: Kernel.IKernel): Rx.Observable<ParsedIOMessage> {
        return null;
    }
