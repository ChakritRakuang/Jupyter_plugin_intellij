import re
import sys
from intellij_py_repl import BasicReplBackend, ReplBackend, UnsupportedReplException, _command_line_to_args_list
from intellij_py_util import to_bytes
try:
    import thread
except:
...
''', True)
    ...
    def attach_process(self, port, debugger_id, **kwargs):
        self.run_command('''
